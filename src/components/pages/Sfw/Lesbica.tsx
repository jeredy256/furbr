...
function LesbicaSFW() {
  ...
  const comentariosRef = ref(db, "coments/sfw/lesbica"); // Caminho para os comentários da página "Lesbica" na categoria SFW
  ...
  return (
    <div className={style.driv}>
      <h2 className={style.h2o}>Comentários para Lesbica (SFW)</h2>
