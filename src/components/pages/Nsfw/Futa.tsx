...
function FutaNSFW() {
  ...
  const comentariosRef = ref(db, "coments/nsfw/futa"); // Caminho para os comentários da página "Futa" na categoria NSFW
  ...
  return (
    <div className={style.driv}>
      <h2 className={style.h2o}>Comentários para Futa (NSFW)</h2>
