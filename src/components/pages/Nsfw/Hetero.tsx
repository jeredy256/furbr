...
function HeteroNSFW() {
  ...
  const comentariosRef = ref(db, "coments/nsfw/hetero"); // Caminho para os comentários da página "Hetero" na categoria NSFW
  ...
  return (
    <div className={style.driv}>
      <h2 className={style.h2o}>Comentários para Hetero (NSFW)</h2>
