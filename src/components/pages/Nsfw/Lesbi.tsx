...
function LesbicoNSFW() {
  const [comentario, setComentario] = useState("");
  const [comentarios, setComentarios] = useState<Comentario[]>([]);
  const comentariosRef = ref(db, "coments/nsfw/lesbico"); // Caminho para os comentários da página "Lesbico" na categoria NSFW
  ...
  return (
    <div className={style.driv}>
      <h2 className={style.h2o}>Comentários para Lesbico (NSFW)</h2>
